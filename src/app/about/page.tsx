            ...
            <Text size='sm'>
                ...
                <List size='sm'>
                    <ListItem>
                        ...
                        . Displays real-time statistics about the player
                        economy, raptor evolution, queen spawn ETA and their
                        health.
                    </ListItem>
                    <ListItem>
                        <Anchor
                        ...
                        . In-chat timing notifications for you and your team.
                        Will remind you when it&apos;s better to start building
                        defences, when the grace period ends and when the queens
                        are about to spawn.
                    </ListItem>
                    <ListItem>
                        <Anchor
                        ...
                        . Divides the &quot;Full Metal Plate&quot; map into
                        equally sized spots to ensure everyone on your team has
                        enough buildable space.
                    </ListItem>
                    <ListItem>
                        <Anchor
                    ...
                    <ListItem>
                        ...
                        . Automatically place the next building in your build
                        queue once the current structure is almost done. This
                        helps maintain building momentum by minimizing idle time
                        as the construction unit walks between placement
                        locations.
                    </ListItem>
                    <ListItem>
                        <Anchor
                        ...
                        . Allows you to build structures over other existing
                        ones.
                    </ListItem>
                    <ListItem>
                        <Anchor
                        ...
                        . Split your long build queue between multiple
                        constructors.
                    </ListItem>
                </List>
            </Text>
            ...
            <Text size='sm'>
                <List size='sm'>
                    <ListItem>
                        ...
                        . The main repository for this project. You can report
                        bugs and request new features here.
                    </ListItem>
                    <ListItem>
                        <Anchor
                    ...
                    <ListItem>
                        ...
                        . The main site for the game. Game replays can be
                        downloaded here.
                    </ListItem>
                </List>
            </Text>
